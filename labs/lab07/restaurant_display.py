...
print(f"---Menu---")
print(f"1) {menu_data.item1}: RM{menu_data.item1_price}")
print(f"2) {menu_data.item2}: RM{menu_data.item2_price}")
print(f"3) {menu_data.item3}: RM{menu_data.item3_price}")
